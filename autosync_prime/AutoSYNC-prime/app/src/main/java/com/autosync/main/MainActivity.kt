...
@AndroidEntryPoint
    ...
    private fun scheduleServiceReminder(context: android.content.Context) {
        val alarmManager = context.getSystemService(android.content.Context.ALARM_SERVICE) as android.app.AlarmManager
        val intent = android.content.Intent(context, com.autosync.main.notification.ServiceReminderReceiver::class.java)
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("assistant") {
                com.autosync.main.ui.screens.assistant.AssistantScreen(
                    onNavigateBack = { navController.popBackStack() }
                )
            }
        }
