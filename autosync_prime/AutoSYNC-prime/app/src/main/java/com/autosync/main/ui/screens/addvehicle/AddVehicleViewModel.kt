...
class AddVehicleViewModel @Inject constructor(
    ...
    val currentMileage = MutableStateFlow("") // New Field
    ...
    private fun loadVehicle(id: Int) {
        viewModelScope.launch {
            ...
            vehicle?.let {
                ...
                currentMileage.value = it.currentMileage.toString() // Load mileage
    ...
    fun saveVehicle() {
        ...
        viewModelScope.launch {
            ...
            val vehicle = Vehicle(
                ...
                currentMileage = currentMileage.value.toIntOrNull() ?: 0
            )
